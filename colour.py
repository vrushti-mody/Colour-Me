...
version = 'MLH Hack From The Past'

prototxt = r'model/colour.prototxt'
model = r'model/colour.caffemodel'
...
if not os.path.isfile(model):
    sg.popup_scrolled('Missing model file', 'You are missing the file "colour.caffemodel"',
...
left_col = [
            ...
            [sg.Text('Wanda Vision, ' + version, font='Courier 8')]]
...
# ----- Make the window -----
window = sg.Window('Colour.me', layout, grab_anywhere=True)
